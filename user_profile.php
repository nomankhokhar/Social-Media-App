        ...
        <div class="col-sm-12">
            ...
            if(isset($_GET['u_id'])){
                   ...
                   <center>
                      <div class='col-sm-3' style='background-color:#e6e6e6;'>
                         ...
                         <ul class='list-group'>
                             ...
                             <li class='list-group-item' title='UserStatus'><strong style='color:grey;'>$describe_user</strong></li>
                             ...
                             <li class='list-group-item' title='reg_date'><strong>$register_date</strong></li>
                         </ul>
                ";
                ...
                if($user_id == $userown_id){
                    echo "
                    <a href='edit_profile.php?u_id=$userown_id' class='btn btn-success'/>
                    Edit Profile </a><br>
                    ";
                }
                else{
         ...
         <div class="col-sm-8">
            <center><h1>
               <strong> <?php echo "$f_name $l_name" ; ?></strong>
             Posts</h1></center>
            <?php
             global $con;
             if(isset($_GET['u_id'])){
              ...
              while($row_posts = mysqli_fetch_array($run_posts)){
                ...
                if($content=="No" && strlen($upload_image) >= 1){
                    ...
                    <div class='own_posts'>
                       <div class='row'>
                           <div class='col-sm-2'>
                              <p><img src='users/$user_image' class='img-circle' width='108px' height='100px'></p>
                           </div>
