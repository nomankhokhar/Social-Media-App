...
<div class="row">
	...
	<div class="col-sm-8">
		<?php
			...
			<div id='profile-img'>
				<img src='users/$user_image' alt='Profile' class='img-circle' width='200px' height='200px' style=' background-position: center;'>
				<form action='profile.php?u_id='$user_id' method='post' enctype='multipart/form-data'>
			   ...
			   while($row_posts = mysqli_fetch_array($run_posts))
			   {
						...
						if($content=="No" && strlen($upload_image) >= 1)
						{
							...
							if($user_id != $user_email)
							{
								...
								<a href='single.php?post_id=$post_id' style='float:right;'><button class='btn btn-info'>Edit</button></a>
								<a href='functions/delete_post.php?post_id=$post_id' style='float:right;'><button class='btn btn-danger'>Delete</button></a><br>
								";
							}
