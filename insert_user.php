...
if(isset($_POST['sign_up'])){
    ...
    values('$first_name','$last_name','$username','Hello MySocial.This is my default status!','...','$pass','$email','$country','$gender','$birthday','default_cover.jpg','default_cover.jpg',NOW(),'$status','$posts','Iwanttoputading intheuniverse.')";
    
    $query = mysqli_query($con, $insert);

    if($query){
        echo "<script>alert('Well Done $first_name, Enjoy FreeDom Speech')</script>";
